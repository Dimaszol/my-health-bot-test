...
from db import get_documents_by_user, update_document_confirmed, get_user_language, t
from vector_db import mark_chunks_unconfirmed
...
async def send_note_controls(message: types.Message, doc_id: int):
    from db import get_document_by_id, get_user_language, t
